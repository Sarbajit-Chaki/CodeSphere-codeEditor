...
const SelectLanguage = () => {
  return (
    <div className="relative rounded-md w-full flex justify-center items-center">
      ...
      {/* Select Language box */}
      <div className="relative z-10  min-w-fit max-w-[620px] min-h-fit p-6 bg-white/5 backdrop-blur-lg shadow-lg border border-white/30 rounded-md text-gray-200">
        <p className="text-lg">Select a language</p>
          ...
          >
            <div className="flex w-full justify-between">
              <div className="flex items-center gap-x-4">
                ...
                <div>
                  <p className="text-purple-300 font-semibold">JOIN ROOM</p>
