    ...
    <>
      <div className="w-full h-fit lg:h-full flex flex-col-reverse lg:flex-col lg:px-12 lg:py-8">
        <nav className=' flex items-center justify-center lg:justify-end gap-x-4 lg:gap-x-6 mt-2 lg:mt-0'>
          <div className=' text-[#b1b1b1] '>Not a Memeber?</div>
          <Button text="SIGN IN" className={" hidden lg:block px-8 py-3"} />
          <div className=' text-[#b1b1b1] hover:text-[#fb4c19] hover:underline block lg:hidden'>SIGN IN</div>
        </nav>
